...
export interface Member {
  ...
  weekendSlots?: MeetingSlot[]; // Retrocompatibilidad para fin de semana
  saturdaySlots?: MeetingSlot[]; // Franjas específicas para Sábado
  sundaySlots?: MeetingSlot[];   // Franjas específicas para Domingo
  busySlots: TimeSlot[];
