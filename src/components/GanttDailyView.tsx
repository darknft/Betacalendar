                  ...
                  >
                    <div className={`rounded-2xl p-3 transition-all flex flex-col justify-between gap-2.5 min-h-[200px] ${slotContainerStyle}`}>
                      ...
                      <div className="flex items-center justify-between gap-1 pb-1">
                        {isAllCoincide ? (
                          <>
                            ...
                            <div className="flex items-center gap-1.5">
                              <span className="text-[11px] font-mono font-bold bg-white text-emerald-900 px-2 py-0.5 rounded-md border border-emerald-300 shadow-2xs">
                        ...
                        {/* Slot Members List: Shows all active members; non-coinciding members rendered in gentle gray */}
